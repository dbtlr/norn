...
| [`describe`](commands/describe.md) | Describe the vault: structure counts and inbox — the declared rules and schema in full with `--schema`, a contents-summary with `--data`. |
